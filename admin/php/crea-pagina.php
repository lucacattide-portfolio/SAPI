                  ...
                  <div class="row col-md-6">
                    <div class="Gal col-md-12 unit">
                        ...
                        <div class="input prepend-small-btn">
                            ...
                            <input type="text" placeholder="<?php if($_GET["id"] == 3): ?>Formato 1920px X 1080px<?php else: ?>no file selected<?php endif; ?>" readonly id="prepend-small-btn" class="form-control">
                         </div>
                     </div>
